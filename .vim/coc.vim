...
xmap <leader>ccas  <Plug>(coc-codeaction-selected)
nmap <leader>ccas  <Plug>(coc-codeaction-selected)

" Remap for do codeAction of current line
nmap <leader>ccaa  <Plug>(coc-codeaction)
" Fix autofix problem of current line
nmap <leader>ccff  <Plug>(coc-fix-current)
